import{b as w,i as f,R as C,S as M,N as D,P as _,A as U,a as V}from"./assets/vendor-DJ86wize.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();async function K(e){return(await w.get(`https://deserts-store.b.goit.study/api/desserts/${e}`)).data}function Y(e){const t=Math.floor(e),s=e%1!==0,a=5-t-(s?1:0);return`
  ...
  `}const A=document.querySelector("[data-loader]");function G(){A.classList.remove("is-hidden")}function J(){A.classList.add("is-hidden")}const Q="https://deserts-store.b.goit.study/api/orders",B="6852a9fcb459460cb6b47748",l=document.querySelector("[data-order-backdrop]"),y=document.querySelector("[data-order-close]"),u=document.querySelector("[data-order-form]");let T=B;function W(e){f.success({title:"Успіх",message:`Замовлення №${e} успішно створено!`,position:"topRight",timeout:4e3})}function S(e){f.error({title:"Помилка",message:e,position:"topRight",timeout:5e3})}function x(e=B){l&&(T=e,l.classList.remove("is-hidden"),document.body.classList.add("modal-open"),document.addEventListener("keydown",P))}function b(){l&&(l.classList.add("is-hidden"),document.body.classList.remove("modal-open"),document.removeEventListener("keydown",P))}function P(e){e.key==="Escape"&&b()}function X(e){e.target===e.currentTarget&&b()}async function Z(e){var r,n;e.preventDefault();const t=u.querySelector(".order-form-submit"),s=new FormData(u),a={name:s.get("name").trim(),phone:s.get("phone").trim(),dessertId:T,comment:s.get("comment").trim()};if(!a.name||!a.phone||!a.comment){S("Будь ласка, заповніть усі поля форми.");return}try{t&&(t.disabled=!0);const i=await w.post(Q,a);W(i.data.orderNum),u.reset(),b()}catch(i){const F=((n=(r=i.response)==null?void 0:r.data)==null?void 0:n.message)||"Не вдалося створити замовлення. Перевірте дані та спробуйте ще раз.";S(F),console.error(i)}finally{t&&(t.disabled=!1)}}y==null||y.addEventListener("click",b);l==null||l.addEventListener("click",X);u==null||u.addEventListener("submit",Z);window.openOrderModal=x;const d={inner:document.querySelector("[data-modal-inner]"),backdrop:document.querySelector("[data-modal]"),content:document.querySelector("[data-modal-content]"),closeBtn:document.querySelector("[data-modal-close]")};async function ee(e){d.backdrop.classList.remove("is-hidden"),document.body.style.overflow="hidden",d.content.innerHTML="",G();try{const t=await K(e);d.content.innerHTML=z(t);const s=document.querySelector(".order-btn");s.disabled=!1,s.addEventListener("click",()=>{s.disabled=!0,g(),x(e)})}catch{f.error({title:"Error",message:"Illegal operation"})}finally{J()}}function g(){d.backdrop.classList.add("is-hidden"),document.body.style.overflow="",d.content.innerHTML=""}d.closeBtn.addEventListener("click",g);d.backdrop.addEventListener("click",e=>{e.target===d.backdrop&&g()});document.addEventListener("keydown",e=>{e.key==="Escape"&&g()});const te="/team-project-04/assets/icons-BoSAtLQJ.svg",L=document.querySelector(".desserts-list"),v=document.querySelector(".load-more-btn"),$=document.querySelector(".loader"),I=document.querySelector(".categories-list-desktop"),O=document.querySelector(".categories-list-tablet");let p=1,m="";v.addEventListener("click",ae);O.addEventListener("change",async e=>{m=e.target.value,await N()});I.addEventListener("change",async e=>{e.target.name==="dessert"&&(m=e.target.value,await N())});L.addEventListener("click",async e=>{const t=e.target.closest(".desserts-item-btn");if(!t)return;const s=t.dataset.id;await ee(s)});async function N(){p=1,L.innerHTML="",await k()}async function R(e){const{data:t}=await w(`https://deserts-store.b.goit.study/api/${e}`);return t}R("categories").then(e=>{se(e)}).catch(e=>{f.error({title:"Помилка",message:"Щось пішло не так, спробуйте пізніше",position:"topRight"})});function se(e){I.innerHTML=`<input type="radio" name="dessert" value="" id="all" checked>
    ...
    ${e.map(({_id:t,name:s})=>`
     ...
     ${e.map(({_id:t,name:s})=>`
       <option value="${t}">${s}</option>`).join("")}`}k();function re(e){return e.map(({_id:t,name:s,image:a,description:r,price:n,category:{name:i}})=>`
            ...
            <div class="dessert-card-bottom">
                ...
                <button class="desserts-item-btn" data-id="${t}">
                    <svg height="24" width="24">
                        <use href="${te}#icon-arrow-outward"></use>
                    </svg>
                </button>
            </div>
        </li>
        
        `).join("")}async function ae(){p++,await k()}async function k(){v.classList.add("hidden"),$.classList.remove("hidden");try{let e=`desserts?page=${p}&limit=8`;m&&(e+=`&category=${m}`);const t=await R(e);L.insertAdjacentHTML("beforeend",re(t.desserts)),t.totalItems>p*t.limit&&v.classList.remove("hidden")}catch{f.error({title:"Помилка",message:"Щось пішло не так, спробуйте пізніше",position:"topRight"})}finally{$.classList.add("hidden")}}const ne="https://deserts-store.b.goit.study/api/feedbacks?limit=10",o={list:document.querySelector(".feedback-list"),loader:document.querySelector(".feedback-loader-wrap"),prevBtn:document.querySelector(".feedback-nav-prev"),nextBtn:document.querySelector(".feedback-nav-next"),bottom:document.querySelector(".feedback-bottom"),pagination:document.querySelector(".feedback-pagination")};let h=null;oe();async function oe(){if(o.list)try{const e=await ie();ce(e),o.list.hidden=!1,o.prevBtn.hidden=!1,o.nextBtn.hidden=!1,o.bottom.hidden=!1,le(),ue()}catch(e){o.list.hidden=!1,o.list.innerHTML='<li class="feedback-message">Не вдалося завантажити відгуки. Спробуйте оновити сторінку.</li>',console.error(e)}finally{o.loader.hidden=!0}}async function ie(){const e=await fetch(ne);if(!e.ok)throw new Error(`Feedback request failed: ${e.status}`);return((await e.json()).feedbacks||[]).slice(0,10)}function ce(e){o.list.innerHTML=e.map(de).join("")}function de({_id:e,rate:t,description:s,author:a}){return`
